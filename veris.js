...
export function getCachedZeruResult(entityName) {
  ...
  if (Date.now() - entry.timestamp > ZERU_CACHE_TTL) {
...
const ENTITY_GROUND_TRUTH = {
  ...
  'EigenLayer': {
  open_source: { value: 'YES', urls: ['https://github.com/Layr-Labs'], confidence: 100 },
  active_github: { value: 'YES', urls: ['https://github.com/Layr-Labs'], confidence: 100 },
  live_product: { value: 'YES', urls: ['https://www.eigenlayer.xyz'], confidence: 100 },
  clear_use_case: { value: 'YES', urls: ['https://www.eigenlayer.xyz'], confidence: 100 },
  technical_docs: { value: 'YES', urls: ['https://docs.eigenlayer.xyz'], confidence: 100 },
  audit_found: { value: 'YES', urls: ['https://github.com/Layr-Labs/eigenlayer-contracts'], confidence: 95 },
  whitepaper: { value: 'YES', urls: ['https://docs.eigenlayer.xyz/eigenlayer/overview/whitepaper'], confidence: 95 },
  founders_named: { value: 'YES', urls: ['https://www.eigenlayer.xyz'], confidence: 90 },
  founded_year: 2023,
  ecosystem_level: 'major',
  adoption_level: 'large',
},
'Morpho': {
  ...
  clear_use_case: { value: 'YES', urls: ['https://morpho.org'], confidence: 100 },
...
'Sonic': {
  open_source: { value: 'YES', urls: ['https://github.com/soniclabs'], confidence: 100 },
  active_github: { value: 'YES', urls: ['https://github.com/soniclabs'], confidence: 100 },
  live_product: { value: 'YES', urls: ['https://www.soniclabs.com'], confidence: 100 },
  clear_use_case: { value: 'YES', urls: ['https://www.soniclabs.com'], confidence: 100 },
  technical_docs: { value: 'YES', urls: ['https://docs.soniclabs.com'], confidence: 100 },
  founded_year: 2024,
  ecosystem_level: 'growing',
  adoption_level: 'small',
},
  'MakerDAO': {
...
const ENHANCED_ENTITY_MAP = {
  ...
  'lunc':                    { entity: 'Terra Luna',  type: 'l1l2' },
  'ust':                     { entity: 'Terra Luna',  type: 'l1l2' },
  'terrausd':                { entity: 'Terra Luna',  type: 'l1l2' },
  'do kwon':                 { entity: 'Terra Luna',  type: 'l1l2' },
